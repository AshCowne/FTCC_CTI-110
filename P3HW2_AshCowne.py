...
employee_over_time_pay = (employee_over * employee_pay_rate)
...
print(f"{employee_hours:<42} {employee_pay_rate:<36} {employee_over:<42} {employee_over_time_pay:<42} {employee_noramal_pay:<42} {employee_gross_pay:<42}");
print("-------"*40);
